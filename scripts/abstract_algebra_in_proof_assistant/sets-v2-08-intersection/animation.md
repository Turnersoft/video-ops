---
videoOps: 1
scriptId: sets-v2-08-intersection
...
math-board: Judson §1.2 — Intersection
...
Same pattern as union, which is a structure inheriting Set.
...
Union and Intersect both inherit Set, so the result is always a set.
