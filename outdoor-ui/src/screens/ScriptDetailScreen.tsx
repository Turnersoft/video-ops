...
import { TakeStepstones } from '../components/TakeStepstones';
...
export function ScriptDetailScreen({ scriptId }: ScriptDetailScreenProps) {
  ...
  const { navigateToLibrary, navigateToPlatforms, navigateToAnimation, navigateToTake } =
    useOutdoorRoute();
          ...
          api.getLiveScript(scriptId).catch(async () => {
            ...
            if (outdoor.beats?.length) {
              return {
                ...
                source: (outdoor.source as LiveScript['source']) ?? 'animation.json',
            ...
            return {
              ...
              mode: 'timed' as const,
              countdownSeconds: outdoor.countdownSeconds ?? 3,
              source: 'animation.json' as const,
              updatedAt: outdoor.updatedAt ?? null,
              slides: outdoor.slides,
