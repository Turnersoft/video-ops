...
export type RemotionCompositionPath = 'video-outdoor-landscape' | 'video-outdoor-portrait';
...
function isRemotionCompositionPath(pathname: string): boolean {
  return pathname === '/video-outdoor-landscape' || pathname === '/video-outdoor-portrait';
}
