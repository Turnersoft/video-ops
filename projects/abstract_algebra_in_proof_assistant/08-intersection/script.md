...
Series order: script_v2 sets #08-intersection
...
Filming: use `/video-ops/editor/08-intersection` — script panel under canvas; overlay off.
...
Textbook beat on math board: Judson §1.2 — Intersection
...
> Same pattern as union — structure inheriting Set.
> Conjunction in the law mirrors textbook and.
...
> Textbook: members in both.
> Turn: Intersect with conjunction in def.
> Lean: mem_inter_iff.
> Union and Intersect both inherit Set — always a set.
...
Intersection — and in the def law: A ∩ B = { x | x ∈ A and x ∈ B }. Turn names the formal object; Lean uses Mathlib lemmas — same meaning, different pedagogy.
