...
import type { CompareFontScales } from '@turn-video-shared/ide/compareFontScale';

import type { VideoOpsCoverOverride } from '@turn-video-shared/videoOpsCover';

import type { LayoutPreset } from '../video-kit/types';
...
export type VideoFromScriptRenderProps = {
    ...
    /** Bumps when animation.json is reloaded in dev — remounts scene/track loaders. */
