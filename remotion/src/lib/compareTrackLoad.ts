...
import type { CompareHintLayout } from '@turn-video-shared/ide/compareHintLayout';
import type { IdeTrack } from '@turn-video-shared/ide/ideTrackTypes';
import type { Lean4GoalExport, Lean4Track } from '@turn-video-shared/ide/lean4TrackTypes';
