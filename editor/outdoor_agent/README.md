...
Browser app: open `http://127.0.0.1:8788/` — library grouped by `video_ops/projects/` series, script detail with pipeline videos, and camera filming (uploads to `/api/upload`).
...
```
projects/{series}/{scriptId}/takes/{takeId}/
