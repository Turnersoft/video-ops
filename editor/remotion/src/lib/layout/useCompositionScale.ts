...
import { useOutdoorLayout } from '../outdoor/outdoorLayoutContext';
import { useScriptStripCollapsed } from '../context/scriptStripUiContext';
...
export function useCompositionScale() {
    ...
    const scriptStripCollapsed = useScriptStripCollapsed();
