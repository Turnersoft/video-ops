...
import { Lean4GoalPanel } from '../Lean4GoalPanel/Lean4GoalPanel';
import {
    leanGoalRenderAvailableAtSeconds,
    type Lean4GoalExport,
    type Lean4Track,
} from '../../lib/tracks/lean4TrackTypes';
import {
    activeBeatCodeSegment,
    resolveFocusedSourceDisplay,
} from '../../lib/tracks/ideTrackTypes';

import { loadLean4Track, type LeanTrackLoadOptions, type LoadedLean4Track } from '../../lib/tracks/loadLean4Track';
...
import { LeanTypingCode } from '../LeanTypingCode/LeanTypingCode';
